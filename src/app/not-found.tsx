  ...
  return (
    <section className="px-5 py-24 text-center sm:px-6 md:py-32">
      ...
      <div className="mt-9 flex flex-wrap justify-center gap-3.5">
        <Link
          href="/collections"
          className="bg-maroon px-8 py-4 text-[12px] font-bold uppercase tracking-[0.2em] text-ivory transition-colors hover:bg-maroon-2"
        >
          Shop the collection
        </Link>
        <Link
          href="/"
          className="border border-ink px-8 py-4 text-[12px] font-bold uppercase tracking-[0.2em] transition-colors hover:bg-ink hover:text-ivory"
        >
          Back home
        </Link>
      </div>
